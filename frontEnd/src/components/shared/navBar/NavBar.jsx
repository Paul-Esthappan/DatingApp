        ...
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5 flex justify-center items-center">
            <img
              ...
              alt=""
            />
            <span className="pl-2 hidden sm:block">Your 2 Company</span>
          </a>
        </div>
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                ...
                <a
                  href="/"
                  onClick={currentUser ? handleLogout : handleLogin}
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-70 hover:bg-gray-50"
                >
                  {currentUser ? "Log out" : "Log in"}
                </a>
              </div>
